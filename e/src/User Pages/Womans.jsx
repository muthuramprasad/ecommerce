...
const Womans = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState("Womans");
  ...
  const filterResult = (categoryItem, attributeKey, attributeValue) => {
    setSelectedCategory("Womans"); // Always set to "Mens" regardless of the checkbox clicked
